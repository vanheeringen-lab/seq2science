...
def get_peak_calling_qc(sample):
    ...
    if str(assembly).lower() in ["ce10", "ce11", "dm3", "dm6", "hg19", "hg38", "mm9", "mm10", "grch38.p13", "grch38", "danrer11",
                                 "asm318616v1", "xentro9", "orylat2", "asm20922v1", "grcg6a", "astyanax_mexicanus-2.0",
                                 "spur_5.0", "KH"]:
