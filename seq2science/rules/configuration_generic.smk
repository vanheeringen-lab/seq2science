...
if "assembly" in samples:
    def parse_assemblies():
        ...
        return providers, has_annotation, all_assemblies, modified, suffix, ori_assemblies, de_contrasts

    PROVIDERS, HAS_ANNOTATION, ALL_ASSEMBLIES, modified, SUFFIX, ORI_ASSEMBLIES, DE_CONTRASTS = parse_assemblies()
