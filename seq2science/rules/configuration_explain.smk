...
if not config.get("explain_rule"):
    ...
    EXPLAIN = {
        ...
        "get_effective_genome_size": f"The effective genome size was estimated per sample by {href_v('khmer')} by calculating the number of unique k-mers in the genome with k being the average read length.",
