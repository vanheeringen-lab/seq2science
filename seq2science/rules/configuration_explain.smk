...
if not config.get("explain_rule"):
    ...
    REFERENCES = {
        ...
        'scRNA-seq': 'https://github.com/Rebecza/scRNA-seq',
    }
    ...
    MESSAGES = {
        ...
        "kb_seurat_pp": f"scRNA count post-processing was performed using the {hyperref('scRNA-seq')} markdown with settings{options('seurat')}.",
    }
